...
eq('upgraded version', m0.version, 2);
...
eq('SCHEMA_VERSION', Calc.SCHEMA_VERSION, 2);

section('schema v1 → v2 (rewards & payments fields)');
...
var FORBIDDEN = ['AKSH0201', 'AKSH', 'UPENDRAN', '6529', '0001010410002538319', '31 MAJESTIC', 'SALIGRAMAM', 'AKSHAYUPENDRAN@GMAIL.COM'];
var walk = [];
